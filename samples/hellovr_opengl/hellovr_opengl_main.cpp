	...
	, m_bShowCubes( true )
{
	...
	//memset(m_rDevClassChar, 0, sizeof(m_rDevClassChar)); // füllt einen Speicherbereich mit Nullen
	// m_rDevClassChar: Für jedes Device wird ein character festgelegt (siehe UpdateHMDMatrixPose())
};
